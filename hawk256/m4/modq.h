...
/*
//extern void regenfg8_jazz(int8_t *restrict f, int8_t *restrict g, const void *seed); // OK
extern void regenfg8_2_jazz(int8_t *restrict f, int8_t *restrict g, const void *seed); // OK

//extern void shake_init_injectx2_flip_extract2(uint8_t *sm, uint8_t *hpub, uint8_t *hm, uint32_t mlen); //FAIL
extern void shake_init_injectx2_flip_extract_2_jazz(uint8_t *hm, uint8_t *sm, uint8_t *hpub, uint32_t mlen); //FAIL

//extern void shake_init_injectx4_flip_extract(uint8_t *hm, const void *priv, uint8_t *tbuf, uint8_t *salt); // OK
extern void shake_init_injectx4_flip_extract_jazz(uint8_t *salt, uint8_t *hm, const void *priv, uint32_t attempt); // OK

//extern void shake_init_injectx2_flip_extract(uint8_t *hm, uint8_t *salt, uint8_t *h1);
extern void shake_init_injectx2_flip_extract_jazz(uint8_t *salt, uint8_t *hm, uint8_t *h1); // OK

extern void extractLowbit2_jazz(uint8_t *d, const int8_t *a); // OK

extern void bpMulMod256New2_jazz(uint8_t *d, const uint8_t *a, const uint8_t *b); // OK

extern void bpXor256_2_jazz(uint8_t *d, const uint8_t *a, const uint8_t *b); // OK

//extern void polysetsmallinplacelow_jazz(uint16_t *d, int32_t *a); // OK
extern void polysetsmallinplacelow_2_jazz(int32_t *d, uint16_t *a); // OK

//extern void polysetsmallinplacehigh_jazz(uint16_t *d, int32_t *a); // OK
extern void polysetsmallinplacehigh_2_jazz(int32_t *d, uint16_t *a); // OK

extern void NTT_unrolled_for_loop_jazz(int32_t *a); // OK

//extern void improvedMul_jazz(int32_t *a, int32_t *b, int32_t *c, uint16_t *ptr); // OK
extern void improvedMul_2_jazz(int32_t *a, int32_t *b);

//extern void polysetsmall_jazz(int32_t *d, const int8_t *a); // OK
extern void polysetsmall_2_jazz(int32_t *d, const int8_t *a); // OK

//extern void bigmul_jazz(int32_t *a, int32_t *b); // OK
extern void bigmul_2_jazz(int32_t *a, int32_t *b); // OK

//extern void iNTT_unrolled_jazz(int32_t *restrict a, uint16_t *x); // OK
extern void iNTT_unrolled_jazz(int32_t *restrict a); // OK

//extern int32_t polySnormSymbreak_jazz(int16_t *x); // OK
extern int32_t polySnormSymbreak_2_jazz(int16_t *x, int32_t *a); // OK

extern uint32_t unnamed_jazz(uint32_t x, int16_t *a, uint8_t *b); // OK
*/
//extern int32_t encodeSig_jazz(uint8_t *d, uint8_t *a, int16_t *b); // OK
//extern int32_t encodeSig_2_jazz(uint8_t *d, uint8_t *a, int16_t *b); // OK

// ============================================================================================

//extern uint32_t sig_gauss_jazz(uint8_t *hm, const void *priv, uint8_t *t, uint32_t attempt);

//extern void sig_gauss_2_exp(int8_t *x0, uint8_t *hm, const void *priv, uint8_t *t);

//extern uint32_t sign_finish_inner_jazz(unsigned char *sig, unsigned char *sm, const unsigned char *sk, uint32_t mlen);

//extern uint32_t test(uint32_t a, uint32_t b, uint32_t c, uint32_t d);